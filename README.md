...
| Day/Lang                     | Python | Rust | C   | Kotlin | Nim | Groovy | Ruby | BQN | Perl | Go  | Java | Elixir | C++ | Clojure | TypeScript | Bash | Haskell | JavaScript | Scala | C#  | T-SQL |
|------------------------------|--------|------|-----|--------|-----|--------|------|-----|------|-----|------|--------|-----|---------|------------|------|---------|------------|-------|-----|-------|
| Solved Days                  | 13     | 13   | 12  | 11     | 10  | 9      | 9    | 8   | 8    | 7   | 7    | 6      | 6   | 5       | 5          | 5    | 4       | 3          | 3     | 2   | 1     |
| 01 - Calorie Counting        | ✅     | ✅   | ✅  | ✅     | ✅  | ✅     | ✅   | ✅  | ✅   | ✅  | ✅   | ✅     | ✅  | ✅      | ✅         | ✅   | ✅      | ✅         | ✅    | ✅  | ✅    |
