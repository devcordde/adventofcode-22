...
| Day/Lang                     | Java | Python | Rust | Groovy | C   | Kotlin | Nim | Ruby | BQN | Perl | Go  | Elixir | C++ | Clojure | TypeScript | Bash | Haskell | JavaScript | Scala | C#  | T-SQL |
|------------------------------|------|--------|------|--------|-----|--------|-----|------|-----|------|-----|--------|-----|---------|------------|------|---------|------------|-------|-----|-------|
| Solved Days                  | 14   | 14     | 13   | 13     | 12  | 11     | 10  | 9    | 8   | 8    | 8   | 6      | 6   | 5       | 5          | 5    | 4       | 3          | 3     | 2   | 1     |
| 01 - Calorie Counting        | ✅   | ✅     | ✅   | ✅     | ✅  | ✅     | ✅  | ✅   | ✅  | ✅   | ✅  | ✅     | ✅  | ✅      | ✅         | ✅   | ✅      | ✅         | ✅    | ✅  | ✅    |
